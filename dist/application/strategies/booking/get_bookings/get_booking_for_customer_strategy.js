...
exports.GetBookingForCustomerStrategy = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../../domain/utils/custom.error");
const constants_1 = require("../../../../shared/constants");
const get_bookings_strategy_mapper_1 = require("../../../mappers/booking/get_bookings_strategy_mapper");
let GetBookingForCustomerStrategy = class GetBookingForCustomerStrategy {
    constructor(_bookingRepository, _customerRepository) {
    ...
    strategy(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const booking = yield this._bookingRepository.findBookingsForUser(page, limit, search, { customerRef: customer._id });
            return get_bookings_strategy_mapper_1.GetBookingResponseMapper.toDTO(booking);
        });
    }
};
exports.GetBookingForCustomerStrategy = GetBookingForCustomerStrategy;
exports.GetBookingForCustomerStrategy = GetBookingForCustomerStrategy = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IBookingRepository')),
    __param(1, (0, tsyringe_1.inject)('ICustomerRepository')),
    __metadata("design:paramtypes", [Object, Object])
], GetBookingForCustomerStrategy);
