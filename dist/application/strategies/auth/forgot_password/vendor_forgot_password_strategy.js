...
exports.VendorForgotPasswordStrategy = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../../domain/utils/custom.error");
const constants_1 = require("../../../../shared/constants");
let VendorForgotPasswordStrategy = class VendorForgotPasswordStrategy {
    ...
    execute(email) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const user = yield this.repo.findOne({ email });
            if (!user) {
            ...
            yield this.emailService.sendResetEmail(email, 'Fixora - Reset Password', resetUrl);
        });
    }
};
exports.VendorForgotPasswordStrategy = VendorForgotPasswordStrategy;
exports.VendorForgotPasswordStrategy = VendorForgotPasswordStrategy = __decorate([
