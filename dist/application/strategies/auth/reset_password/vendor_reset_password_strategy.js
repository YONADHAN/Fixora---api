...
exports.VendorResetPasswordStrategy = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../../domain/utils/custom.error");
const constants_1 = require("../../../../shared/constants");
let VendorResetPasswordStrategy = class VendorResetPasswordStrategy {
    constructor(_vendorRepository, _bcrypt, _redis) {
    ...
    resetPassword(email, newPassword, token) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const user = yield this._vendorRepository.findOne({ email });
            if (!user) {
            ...
            yield this._vendorRepository.update({ email }, { password: hashedPassword });
        });
    }
};
exports.VendorResetPasswordStrategy = VendorResetPasswordStrategy;
exports.VendorResetPasswordStrategy = VendorResetPasswordStrategy = __decorate([
