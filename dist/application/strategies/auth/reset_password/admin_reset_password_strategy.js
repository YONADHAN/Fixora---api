...
exports.AdminResetPasswordStrategy = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../../domain/utils/custom.error");
const constants_1 = require("../../../../shared/constants");
let AdminResetPasswordStrategy = class AdminResetPasswordStrategy {
    constructor(_adminRepo, _bcrypt, _redis) {
    ...
    resetPassword(email, newPassword, token) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const user = yield this._adminRepo.findOne({ email });
            if (!user)
            ...
            yield this._adminRepo.update({ email }, { password: hashedPassword });
        });
    }
};
exports.AdminResetPasswordStrategy = AdminResetPasswordStrategy;
exports.AdminResetPasswordStrategy = AdminResetPasswordStrategy = __decorate([
