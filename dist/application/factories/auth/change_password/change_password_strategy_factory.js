...
let ChangePasswordFactory = class ChangePasswordFactory {
    ...
    execute(currentPassword, newPassword, userId, role) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (role) {
                case 'admin':
                    return yield this._changeAdminPasswordStrategy.execute(currentPassword, newPassword, userId);
                case 'vendor':
                    return yield this._changeVendorPasswordStrategy.execute(currentPassword, newPassword, userId);
                case 'customer':
                    return yield this._changeCustomerPasswordStrategy.execute(currentPassword, newPassword, userId);
                default:
