    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (bannerImage) {
        if (category.bannerImage) {
          yield this._storageService.deleteFile(
            config_1.config.storageConfig.bucket,
            category.bannerImage
          )
        }
        bannerImageUrl = yield this._storageService.uploadFile(
          config_1.config.storageConfig.bucket,
          bannerImage,
          'service-categories'
        )
      ...
      yield this._serviceCategoryRepository.update(
        { serviceCategoryId: categoryId },
        category
      )
    })
