...
let GetWalletUseCase = class GetWalletUseCase {
    constructor(_walletRepository, _walletTransactionRepository, _customerRepository, _vendorRepository) {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ userId, role, }) {
            ...
            const user = role === 'customer'
                ...
                : yield this._vendorRepository.findOne({ userId });
            if (!user || !user._id) {
                return {
                    wallet: null,
                    transactions: [],
            ...
            return {
                wallet: {
                    ...
                    balance: (_b = wallet.balance) !== null && _b !== void 0 ? _b : 0,
