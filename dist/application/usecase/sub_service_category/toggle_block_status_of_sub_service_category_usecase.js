...
exports.ToggleBlockStatusOfSubServiceCategoryUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom.error");
const constants_1 = require("../../../shared/constants");
let ToggleBlockStatusOfSubServiceCategoryUseCase = class ToggleBlockStatusOfSubServiceCategoryUseCase {
    ...
    execute(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (blockStatus === oldStatus) {
                throw new custom_error_1.CustomError(`Status ${blockStatus} already exists.`, constants_1.HTTP_STATUS.CONFLICT);
            }
            const data = {
...
exports.ToggleBlockStatusOfSubServiceCategoryUseCase = ToggleBlockStatusOfSubServiceCategoryUseCase;
exports.ToggleBlockStatusOfSubServiceCategoryUseCase = ToggleBlockStatusOfSubServiceCategoryUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('ISubServiceCategoryRepository')),
    __metadata("design:paramtypes", [Object])
], ToggleBlockStatusOfSubServiceCategoryUseCase);
