...
let CancelBookingUseCase = class CancelBookingUseCase {
    constructor(_cancelBookingFactory) {
        this._cancelBookingFactory = _cancelBookingFactory;
    }
    execute(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._cancelBookingFactory.getStrategy(payload);
        });
    }
};
...
exports.CancelBookingUseCase = CancelBookingUseCase = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('ICancelBookingFactory')),
