...
exports.ExpireBookingHoldsUseCase = void 0;
const tsyringe_1 = require("tsyringe");
let ExpireBookingHoldsUseCase = class ExpireBookingHoldsUseCase {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            const now = new Date();
            const expiredHolds = yield this._bookingHoldRepository.findExpiredActiveHolds(now);
            for (const hold of expiredHolds) {
                yield this._bookingHoldRepository.markHoldAsExpired(hold.holdId);
...
exports.ExpireBookingHoldsUseCase = ExpireBookingHoldsUseCase;
exports.ExpireBookingHoldsUseCase = ExpireBookingHoldsUseCase = __decorate([
