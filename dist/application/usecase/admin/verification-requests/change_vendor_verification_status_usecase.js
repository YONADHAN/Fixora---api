...
let ChangeVendorVerificationStatusUseCase = class ChangeVendorVerificationStatusUseCase {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ userId, verificationStatus, adminId, description, }) {
            ...
            if (((_b = vendor.isVerified) === null || _b === void 0 ? void 0 : _b.status) === verificationStatus) {
            ...
            const finalDescription = verificationStatus === 'accepted'
                ...
                : (description === null || description === void 0 ? void 0 : description.trim()) || 'Rejected by admin.';
            /**
