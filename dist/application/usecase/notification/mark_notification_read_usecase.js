...
let MarkNotificationReadUseCase = class MarkNotificationReadUseCase {
    ...
    execute(notificationId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const notification = yield this.notificationRepository.findOne({
                notificationId,
                recipientId: userId,
                isActive: true,
            });
            if (!notification) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.NOTIFICATION_NOT_FOUND, 404);
            }
