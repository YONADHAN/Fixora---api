...
let AdminController = class AdminController {
    ...
    async getAllVendorRequests(req, res) {
        try {
    ...
    async changeMyUserBlockStatus(req, res) {
        try {
    ...
    async changeMyVendorVerificationStatus(req, res) {
        try {
            ...
            const response = await this._changeVendorVerificationStatusUseCase.execute({
                userId,
                verificationStatus,
                adminId,
                description,
