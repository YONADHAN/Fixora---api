...
let AdminController = class AdminController {
  constructor(
    ...
    _getAllUsersUsecase,
    _changeMyUserBlockStatusUseCase,
    _getAllVendorRequests,
    _changeVendorVerificationStatusUseCase
  ) {
    ...
    this._changeVendorVerificationStatusUseCase =
      _changeVendorVerificationStatusUseCase
  }
  logout(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        ;(0, cookie_helper_1.clearAuthCookies)(
          res,
          accessTokenName,
          refreshTokenName
        )
  ...
  changeMyVendorVerificationStatus(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const response =
          yield this._changeVendorVerificationStatusUseCase.execute({
            userId,
            verificationStatus,
            adminId,
            description,
...
exports.AdminController = AdminController = __decorate(
  [
    ...
    __param(
      5,
      (0, tsyringe_1.inject)('IChangeVendorVerificationStatusUseCase')
    ),
