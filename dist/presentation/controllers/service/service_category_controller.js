...
let ServiceCategoryController = class ServiceCategoryController {
    constructor(_getAllServiceCategoryUseCase, _createServiceCategoryUseCase, _editServiceCategoryUseCase, _blockServiceCategoryUseCase, _getSingleServiceCategoryUseCase) {
    ...
    async editServiceCategory(req, res) {
        try {
            ...
            const bannerImage = req.file;
            await this._editServiceCategoryUseCase.execute(categoryId, name, description, bannerImage);
            res.status(200).json({
                success: true,
    ...
    async blockServiceCategory(req, res) {
        try {
    ...
    async getSingleServiceCategory(req, res) {
        try {
