...
let ServiceCategoryController = class ServiceCategoryController {
    constructor(_getAllServiceCategoryUseCase, _createServiceCategoryUseCase, _editServiceCategoryUseCase, _blockServiceCategoryUseCase, _getSingleServiceCategoryUseCase, _getActiveSubServiceCategories) {
        ...
        this._getActiveSubServiceCategories = _getActiveSubServiceCategories;
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(constants_1.HTTP_STATUS.OK).json({
                    message: constants_1.SUCCESS_MESSAGES.SERVICE_CATGORIES_CREATED_SUCCESSFULLY,
                });
            }
            catch (error) {
                (0, error_handler_1.handleErrorResponse)(req, res, error);
    ...
    editServiceCategory(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const bannerImage = req.file;
                yield this._editServiceCategoryUseCase.execute(categoryId, name, description, bannerImage);
                res.status(200).json({
                    success: true,
                    message: constants_1.SUCCESS_MESSAGES.SERVICE_CATEGORIES_EDITED_SUCCESSFULLY,
                });
            }
            catch (error) {
                (0, error_handler_1.handleErrorResponse)(req, res, error);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res
                    ...
                    .json({ message: constants_1.SUCCESS_MESSAGES.SERVICE_BLOCKED_SUCCESSFULLY });
            }
            catch (error) {
                (0, error_handler_1.handleErrorResponse)(req, res, error);
            }
    ...
    getActiveServiceCategories(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this._getActiveSubServiceCategories.execute();
                res.status(constants_1.HTTP_STATUS.OK).json({
                    success: true,
                    message: constants_1.SUCCESS_MESSAGES.SERVICE_CATEGORIES_FOUND_SUCCESSFULLY,
                    data: response,
                });
            }
            catch (error) {
...
exports.ServiceCategoryController = ServiceCategoryController = __decorate([
    ...
    __param(5, (0, tsyringe_1.inject)('IGetActiveServiceCategoriesUseCase')),
