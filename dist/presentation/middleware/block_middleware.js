...
let BlockMyUserMiddleware = class BlockMyUserMiddleware {
    constructor(_customerRepository, _vendorRepository, _revokeRefreshTokenUsecase, _blacklistTokenUsecase) {
        ...
        this.checkMyUserBlockStatus = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = req.user;
                if (!user) {
                ...
                if (!status) {
                    ...
                    yield redis_client_1.redisClient.set(cacheKey, String(status !== null && status !== void 0 ? status : 'null'), { EX: 3600 });
                }
                if (status !== 'active') {
                    try {
