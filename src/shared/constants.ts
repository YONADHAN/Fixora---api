...
export const SUCCESS_MESSAGES = {
  ...
  VENDOR_REQUESTS_RETRIEVED_SUCCESSFULLY: 'Vendor requests retrieved successfully',
  ...
  BALANCE_PAYMENT_SESSION_CREATED: 'Balance payment session created',
  ...
  DASHBOARD_STATS_RETRIVED_SUCCESSFULLY: 'Dashboard stats retrived successfully',
  DOCUMENTS_UPLOADED_AND_SAVED_SUCCESSFULLY: 'Documents uploaded and saved successfully',
  PAYMENTS_FETCHED_SUCCESSFULLY: 'Payments fetched successfully',
  RATINGS_AND_REVIEWS_ARE_FETCHED_SUCCESFULLY: 'Ratings and Reviews are fetched succesfully.',
  SUCCESSFULLY_CREATED_RATINGS_AND_REVIEWS: 'Successfully created ratings and reviews.',
  SUCCESSFULLY_EDITED_THE_RATINGS_AND_REVIEWS: 'Successfully edited the ratings and reviews.',
  DELETED_THE_RATINGS_AND_REVIEWS_SUCCESSFULLY: 'Deleted the ratings and reviews successfully.',
  GET_RATINGS_AND_REVIEWS_FOR_BOOKED_SERVICES: 'Get ratings and reviews for booked services.',
  ...
  SUBSCRIPTION_PLAN_STATUS_UPDATED_SUCCESSFULLY: 'Subscription plan status updated successfully',
  ACTIVE_SUBSCRIPTION_PLANS_FETCHED_SUCCESSFULLY: 'Active subscription plans fetched successfully',
  SUBSCRIPTION_CHECKOUT_CREATED_SUCCESSFULLY: 'Subscription checkout created successfully',
  SUBSCRIPION_ELIGIBILITY_CHECKED_SUCCESSFULLY: 'Subscripion eligibility checked successfully',
...
export const ERROR_MESSAGES = {
  ...
  YOU_ARE_NOT_ALLOWED_TO_VIEW_THIS_CHAT: 'You are not allowed to view this chat',
  YOU_ARE_NOT_ALLOWED_TO_READ_THIS_CHAT: 'You are not allowed to read this chat',
  YOU_ARE_NOT_A_PARTICIPANT_OF_THIS_CHAT: 'You are not a participant of this chat',
  ROLE_USERID_AND_STATUS_ARE_REQUIRED: 'role, userId, and status are required',
  NO_FILE_UPLOADED: 'No file uploaded',
  NO_FILES_UPLOADED: 'No files uploaded',
  FAILED_TO_UPLOAD_FILES: 'Failed to upload files',
  CATEGORY_NOT_FOUND: 'Category not found',
  UNAUTHORIZED_USER: 'Unauthorized',
  SEED_ADMIN_EMAIL_IS_NOT_PROVIDED: 'Seed Admin email is not provided',
  SEED_ADMIN_PASSWORD_IS_NOT_GIVEN: 'Seed Admin Password is not given',
  SEED_ADMIN_NAME_IS_NOT_GIVEN: 'Seed admin name is not given',
  SEED_ADMIN_PHONE_NUMBER_IS_NOT_GIVEN: 'Seed admin phone number is not given',
  VENDOR_ALREADY_HAS_THIS_VERIFICATION_STATUS: 'Vendor already has this verification status',
  NO_VENDOR_REQUESTS_FOUND: 'No vendor requests found',
  GOOGLE_LOGIN_NOT_SUPPORTED_FOR_THIS_ROLE: 'Google login not supported for this role',
  INVALID_GOOGLE_TOKEN: 'Invalid Google token',
  RATING_AND_REVIEW_IS_NOT_EXISTING: 'Rating and review is not existing.',
  ERROR_MESSAGES_ERROR_IN_DELETION: 'Error in deletion',
